...
suspend fun populateInitialData(db: AppDatabase) {
    ...
    val sampleEmails = listOf(
        EmailEntity(
            ...
            senderEmail = "eleanor.vance@company.com",
            recipientEmail = "sarah.j@aura.mail",
            subject = "Q4 Roadmap Feedback",
            snippet = "Summary: Project Status update",
            body = "Hi Sarah,\n\nI reviewed the Q4 proposal thoroughly. I've highlighted key budget alignment items that need final approval by Friday. Overall, the team has approved the design direction.\n\nLet's make sure our timelines stay on track for next sprint.\n\nBest,\nEleanor Vance\nVP of Product",
            timestamp = now - 1000 * 60 * 12, // 11:04 AM
            isRead = false,
            isStarred = true,
            folder = EmailFolder.INBOX,
            category = EmailCategory.PRIMARY,
            priority = EmailPriority.HIGH,
            tags = "High Impact, Work, AI Focus: High Impact",
            aiSummary = "Eleanor reviewed the proposal, highlighted budget alignment by Friday. Approved the design direction.",
            aiActionItems = "• Aura Reply: Confirm Timelines\n• Reply: Address Budget\n• Create Task\n• Aura Draft: Timelines Clarification",
            replyDraft = "Hi Eleanor,\n\nThanks for reviewing the Q4 roadmap. I've confirmed our delivery timelines and will ensure budget numbers are aligned before Friday.\n\nBest,\nSarah J.",
            deliveryStatus = null,
            hasAttachments = true,
            attachmentNames = "Q4_Roadmap_Proposal.pdf, Budget_Allocation_Q4.xlsx"
        ),
        EmailEntity(
            senderName = "Julian Reed",
            senderEmail = "julian.reed@venturepartners.com",
            recipientEmail = "sarah.j@aura.mail",
            subject = "Partnership Opp.",
            snippet = "Summary: Proposal for collabra...",
            body = "Hi Sarah,\n\nFollowing up on our preliminary discussion regarding strategic integration. We'd love to review the joint partnership proposal this week.\n\nBest,\nJulian Reed",
            timestamp = now - 1000 * 60 * 14, // 11:04 AM
            isRead = false,
            isStarred = false,
            folder = EmailFolder.INBOX,
            category = EmailCategory.PRIMARY,
            priority = EmailPriority.NORMAL,
            tags = "Partnership, Work",
            aiSummary = "Julian reached out regarding the joint partnership proposal and strategic integration.",
            aiActionItems = "• Review partnership agreement\n• Propose meeting slot",
            replyDraft = null,
            deliveryStatus = null,
        ...
        EmailEntity(
            ...
            snippet = "Summary: Team sync notes and updates...",
            body = "Hi Team,\n\nAttached are the action items from our weekly team sync. Please review ahead of Friday's standup.\n\nJulian",
            ...
            priority = EmailPriority.NORMAL,
            tags = "Work, Team",
            aiSummary = "Weekly sync notes and upcoming milestones review.",
            aiActionItems = "• Review sync action items",
            replyDraft = null,
            deliveryStatus = null,
            hasAttachments = true,
            attachmentNames = "Team_Sync_Deck.pdf"
        ),
        EmailEntity(
